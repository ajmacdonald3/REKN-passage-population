...
source("./analysis-code/JAGScode_superpop_phitpt_randomeffect_fixlastentries_2017.R")
...
# Call JAGS from R
PISKLR2017_phitpt <- jags(jags_data, inits, parameters,
                            "js-super.jags",
...
# view results
print(PISKLR2017_phitpt, digits = 3)

summary <- PISKLR2017_phitpt$summary

pdf(file = paste0("./analysis-output/PISKLR2017_superpop_phitpt_traceplots_randomeffect_",
                  Sys.Date(), "_fixlastentry_PXDA500.pdf"))
par(mfrow = c(3, 1))
traceplot(PISKLR2017_phitpt)
dev.off()

# export results as CSV and RDS files
write.csv(PISKLR2017_phitpt$summary,
          file = paste0("./analysis-output/PISKLR2017_superpop_phitpt_summary_randomeffect_",
                        Sys.Date(), "_fixlastentry_PXDA500.csv"))

saveRDS(PISKLR2017_phitpt$summary,
          file = paste0("./analysis-output/PISKLR2017_superpop_phitpt_summary_randomeffect_",
                        Sys.Date(), "_fixlastentry_PXDA500.rds"))

# export more results for stopover duration
write.csv(PISKLR2017_phitpt$sims.list,
          file = paste0("./analysis-output/PISKLR2017_superpop_phitpt_sims.list_randomeffect_",
                        Sys.Date(), "_fixlastentry_PXDA500.csv"))

saveRDS(PISKLR2017_phitpt$sims.list,
          file = paste0("./analysis-output/PISKLR2017_superpop_phitpt_sims.list_randomeffect_",
                        Sys.Date(), "_fixlastentry_PXDA500.rds"))

# save R environment just in case (on external hard drive)
save.image("E:/REKN-passage-population-extra-files/PISKLR2017_phitpt_randomeffect_fixlastentries_2021-01-31_PXDA500_environment.RData")
