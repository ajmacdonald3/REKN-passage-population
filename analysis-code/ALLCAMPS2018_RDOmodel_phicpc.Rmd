...
source("analysis-code/JAGScode_phicpc.R")
...
parameters <- c("psi", "mean.phi", "mean.p", "b", "delta", "pflag", "meanpflag",
...
# Call JAGS from R
ALLCAMPS2018_phicpc <- jags(jags_data, inits, parameters,
                            "RDO-model.jags",
...
# view results
print(ALLCAMPS2018_phicpc, digits = 3)

pdf(file = paste0("./analysis-output/ALLCAMPS2018_RDO_phicpc_traceplots_", Sys.Date(), ".pdf"))
par(mfrow = c(3, 1))
traceplot(ALLCAMPS2018_phicpc)
dev.off()

# export results as CSV file
write.csv(ALLCAMPS2018_phicpc$summary,
          file = paste0("./analysis-output/ALLCAMPS2018_RDO_phicpc_summary_", Sys.Date(), ".csv"))

# export more results for stopover duration
write.csv(ALLCAMPS2018_phicpc$sims.list,
          file = paste0("./analysis-output/ALLCAMPS2018_RDO_phicpc_sims.list_", Sys.Date(), ".csv"))
