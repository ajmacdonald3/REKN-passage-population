...
source("./analysis-code/JAGScode_superpop_phicpc.R")
...
parameters <- c("psi", "mean.phi", "mean.p", "b", "nu",
...
# Call JAGS from R
PISKLR2017_superpop_phicpc <- jags(jags_data, inits, parameters,
                            "js-super.jags",
...
# view results
print(PISKLR2017_superpop_phicpc, digits = 3)

pdf(file = paste0("./analysis-output/PISKLR2017_superpop_phicpc_traceplots_", Sys.Date(), ".pdf"))
par(mfrow = c(3, 1))
traceplot(PISKLR2017_superpop_phicpc)
dev.off()

# export results as CSV file
write.csv(PISKLR2017_superpop_phicpc$summary,
          file = paste0("./analysis-output/PISKLR2017_superpop_phicpc_summary_", Sys.Date(), ".csv"))

# export more results for stopover duration
write.csv(PISKLR2017_superpop_phicpc$sims.list,
          file = paste0("./analysis-output/PISKLR2017_superpop_phicpc_sims.list_", Sys.Date(), ".csv"))
