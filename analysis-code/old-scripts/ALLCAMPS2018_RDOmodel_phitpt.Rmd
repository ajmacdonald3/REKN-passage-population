...
enchist_pxda <- enchist_csv %>% 
  add_row(FlagID = paste0("PXDA", 1:2000)) %>% 
  replace(., is.na(.), "0")
...
source("analysis-code/JAGScode_phitpt.R")
...
parameters <- c("psi", "phi_t", "psight", "b", "delta", "pflag", "meanpflag",
...
pdf(file = paste0("./analysis-output/ALLCAMPS2018_RDO_phitpt_traceplots_", Sys.Date(), "_PXDA2000.pdf"))
par(mfrow = c(3, 1))
...
write.csv(ALLCAMPS2018_phitpt$summary,
          file = paste0("./analysis-output/ALLCAMPS2018_RDO_phitpt_summary_", Sys.Date(), "_PXDA2000.csv"))

# export more results for stopover duration
write.csv(ALLCAMPS2018_phitpt$sims.list,
          file = paste0("./analysis-output/ALLCAMPS2018_RDO_phitpt_sims.list_", Sys.Date(), "_PXDA2000.csv"))
