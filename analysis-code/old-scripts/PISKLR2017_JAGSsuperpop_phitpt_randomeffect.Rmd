...
source("./analysis-code/JAGScode_superpop_phitpt_randomeffect.R")
...
inits <- function(){list(mean.phi = runif(1, 0, 1), sigma_phi = runif(1, 0, 10),
                         mean.p = runif(1, 0, 1), sigma_p = runif(1, 0, 10),
                         psi = runif(1, 0, 1),
                         z = z.init,
                         w = w.init,
                         alpha = runif(1, -1, 1),
...
parameters <- c("psi", "phi_t", "mean.phi", "sigma_phi2",
                "psight", "mean.p", "sigma_p2",
                "b", "nu",
...
# view results
print(PISKLR2017_superpop_phitpt, digits = 3)

pdf(file = paste0("./analysis-output/PISKLR2017_superpop_phitpt_traceplots_", Sys.Date(), ".pdf"))
par(mfrow = c(3, 1))
traceplot(PISKLR2017_superpop_phitpt)
dev.off()

# export results as CSV file
write.csv(PISKLR2017_superpop_phitpt$summary,
          file = paste0("./analysis-output/PISKLR2017_superpop_phitpt_summary_", Sys.Date(), ".csv"))

# export more results for stopover duration
write.csv(PISKLR2017_superpop_phitpt$sims.list,
          file = paste0("./analysis-output/PISKLR2017_superpop_phitpt_sims.list_", Sys.Date(), ".csv"))
