...
source("./analysis-code/JAGScode_superpop_phicpt.R")
...
parameters <- c("psi", "mean.phi", "psight", "b", "nu",
...
# Call JAGS from R
PISKLR2017_superpop_phicpt <- jags(jags_data, inits, parameters,
                            "js-super.jags",
...
# view results
print(PISKLR2017_superpop_phicpt, digits = 3)

pdf(file = paste0("./analysis-output/PISKLR2017_superpop_phicpt_traceplots_", Sys.Date(), ".pdf"))
par(mfrow = c(3, 1))
traceplot(PISKLR2017_superpop_phicpt)
dev.off()

# export results as CSV file
write.csv(PISKLR2017_superpop_phicpt$summary,
          file = paste0("./analysis-output/PISKLR2017_superpop_phicpt_summary_", Sys.Date(), ".csv"))

# export more results for stopover duration
write.csv(PISKLR2017_superpop_phicpt$sims.list,
          file = paste0("./analysis-output/PISKLR2017_superpop_phicpt_sims.list_", Sys.Date(), ".csv"))
